...
| `verify-pricing.mjs` | Every price, credit allowance, seat count, top-up rate and add-on in the built HTML matches `NEW_LADDER_2026` in the backoffice. Parses the whole plan array, so a new tier fails the check rather than being skipped. |
